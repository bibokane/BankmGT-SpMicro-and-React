      ...
      <footer style={styles.footer}>
          <div style={styles.container}>
              <div style={styles.column}>
                  ...
                  <p style={styles.text}>Email: biboscenter@example.com</p>
                  <p style={styles.text}>Phone: (+49) 721-123456</p>
              </div>
              {/* <div style={styles.column}>
        ...
        <p style={styles.copyRight}>© 2023 Habib Kane. All rights reserved.</p>
      </footer>
    </div>
  );
};
