      ...
      <form onSubmit={handleSubmit}>
        <label style={labelStyle}>
          ...
          <select value={creditCardName} onChange={(e) => setCreditCardName(e.target.value)} required>
            ...
            <option value="IndianOil Axis Bank Credit Card">ABC Bank Credit Card</option>
            <option value="Flipkart Axis Bank Credit Card">Förderbank Bank Credit Card</option>
            <option value="Axis Bank MY Zone Credit Card">BDM Credit Card</option>
            <option value="Axis Bank Vistara Credit Card">Umweltschutz Credit Card</option>
            <option value="IRCTC SBI Platinum Card">AAA Platinum Card</option>
            <option value="Air India SBI Platinum Card">Air Afrique Platinum Card</option>
          </select>
        </label>
