          ...
          <MDBCol lg="4">
            <MDBCard className="mb-4">
              <MDBCardBody className="text-center">
                ...
                <p className="text-muted mb-4">Förderbank ABC, Deutschland</p>
            ...
            <MDBCard className="mb-4">
              <MDBCardBody>
                ...
                <MDBRow>
                  ...
                  <MDBCol sm="9">
                    <MDBCardText className="text-muted">Karlsruhe, DE</MDBCardText>
                  </MDBCol>
                </MDBRow>
                <hr />
                <MDBRow>
                  ...
                  <MDBCol sm="9">
                    <MDBCardText className="text-muted">0721-123456</MDBCardText>
                  </MDBCol>
                </MDBRow>
              </MDBCardBody>
            </MDBCard>
