      ...
      <form onSubmit={handleSubmit}>
        ...
        Locker Location:
          <select value={lockerlocation} onChange={(e) => setLockerLocation(e.target.value)} required>
            ...
            <option value="Mumbai">Freiburg</option>
            <option value="Pune">Karlsruhe</option>
            <option value="Delhi">Stuttgart</option>
            <option value="Bengaluru">Mannheim</option>
            <option value="Hyderabad">Frankfurt</option>
          </select>
        </label>
